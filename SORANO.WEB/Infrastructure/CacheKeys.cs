namespace SORANO.WEB.Infrastructure
{
    public static class CacheKeys
    {
        ...
        public static readonly string CreateLocationTypeCacheKey = "CreateLocationTypeCache";

        public static readonly string CreateLocationTypeCacheValidKey = "CreateLocationTypeCacheValid";
